...
SRC = main.cpp UI/UserInterface.cpp UI/AdminInterface.cpp UI/MainInterface.cpp Services/UserServices.cpp Services/AdminServices.cpp Services/FloorServices.cpp Services/LogServices.cpp Services/ValidationServices.cpp # Source code files
